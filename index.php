        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light  border-bottom">
                ...
                <div class="col-md-0 text-center">
                    <h3 class="try" style="text-align: center;">Personal Expense Tracker</h3>
            ...
            <div class="container-fluid">
                <h2 class="mt-4 text-center">Expense Overview</h2>
                <div class="row">
                    <!-- Today's, Yesterday's, Last 7 Days', Last 30 Days', Current Year's, Total Expenses -->
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6 mt-4">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <h5 class="card-title text-center">Daily Expenses Chart</h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mt-4">
                        <div class="card">
                            <div class="card-header bg-success text-white">
                                <h5 class="card-title text-center">Monthly Expenses Chart</h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mt-4">
                        <div class="card">
                            <div class="card-header bg-warning text-white">
                                <h5 class="card-title text-center">Yearly Expenses Chart</h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mt-4">
                        <div class="card">
                            <div class="card-header bg-danger text-white">
                                <h5 class="card-title text-center">Expense Category Chart</h5>
                            </div>
                            <div class="card-body">
